export default {
  ...
  AX: { currency: "EUR", name: "land Islands" },
  ...
  AI: { currency: "XCD", name: "Anguilla" },
  AQ: { currency: "None", name: "Antarctica" },
  ...
  BV: { currency: "NOK", name: "Bouvet Island" },
  BR: { currency: "BRL", name: "Brazil" },
  IO: { currency: "USD", name: "British Indian Ocean Territory" },
  ...
  CX: { currency: "AUD", name: "Christmas Island" },
  CC: { currency: "AUD", name: "Cocos (Keeling) Islands" },
  CO: { currency: "COP", name: "Colombia" },
  KM: { currency: "KMF", name: "Comoros" },
  CG: { currency: "XAF", name: "Congo" },
  CD: { currency: "CDF", name: "Congo, The Democratic Republic of the" },
  CK: { currency: "NZD", name: "Cook Islands" },
  CR: { currency: "CRC", name: "Costa Rica" },
  CI: { currency: "XOF", name: "Cote D'Ivoire" },
  ...
  GL: { currency: "DKK", name: "Greenland" },
  GD: { currency: "XCD", name: "Grenada" },
  GP: { currency: "EUR", name: "Guadeloupe" },
  ...
  HM: { currency: "AUD", name: "Heard Island and Mcdonald Islands" },
  VA: { currency: "EUR", name: "Holy See (Vatican City State)" },
  ...
  KR: { currency: "KRW", name: "Korea, Republic of" },
  ...
  LY: { currency: "LYD", name: "Libyan Arab Jamahiriya" },
  ...
  MQ: { currency: "EUR", name: "Martinique" },
  MR: { currency: "MRU", name: "Mauritania" },
  MU: { currency: "MUR", name: "Mauritius" },
  YT: { currency: "EUR", name: "Mayotte" },
  MX: { currency: "MXN", name: "Mexico" },
  FM: { currency: "USD", name: "Micronesia, Federated States of" },
  ...
  MS: { currency: "XCD", name: "Montserrat" },
  ...
  AN: { currency: "ANG", name: "Netherlands Antilles" },
  NC: { currency: "XPF", name: "New Caledonia" },
  NZ: { currency: "NZD", name: "New Zealand" },
  NI: { currency: "NIO", name: "Nicaragua" },
  NE: { currency: "XOF", name: "Niger" },
  NG: { currency: "NGN", name: "Nigeria" },
  NU: { currency: "NZD", name: "Niue" },
  NF: { currency: "AUD", name: "Norfolk Island" },
  ...
  PS: { currency: "ILS", name: "Palestinian Territory, Occupied" },
  ...
  SJ: { currency: "NOK", name: "Svalbard and Jan Mayen" },
  ...
  TW: { currency: "TWD", name: "Taiwan, Province of China" },
  ...
  TC: { currency: "USD", name: "Turks and Caicos Islands" },
  ...
  UM: { currency: "USD", name: "United States Minor Outlying Islands" },
  UY: { currency: "UYU", name: "Uruguay" },
  UZ: { currency: "UZS", name: "Uzbekistan" },
  VU: { currency: "VUV", name: "Vanuatu" },
  VE: { currency: "VEF", name: "Venezuela" },
  VN: { currency: "VND", name: "Viet Nam" },
  VG: { currency: "USD", name: "Virgin Islands, British" },
  VI: { currency: "USD", name: "Virgin Islands, U.S." },
  WF: { currency: "XPF", name: "Wallis and Futuna" },
  EH: { currency: "MAD", name: "Western Sahara" },
  YE: { currency: "YER", name: "Yemen" },
  ZM: { currency: "ZMW", name: "Zambia" },
  ZW: { currency: "USD", name: "Zimbabwe" },
};
